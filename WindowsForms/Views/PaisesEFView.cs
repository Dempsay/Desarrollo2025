...
namespace WindowsForms.Views
{
    public partial class PaisesEFView : Form
    {
        ...
        private void GridPeliculas_SelectionChanged_1(object sender, EventArgs e)
        {
            ...
            {
                Pais paisSeleccionado = (Pais)GridPaises.SelectedRows[0].DataBoundItem;
            }
        }
        ...
        private async void BtnEliminar_Click_1(object sender, EventArgs e)
        {
            ...
            if (GridPaises.RowCount > 0 && GridPaises.SelectedRows.Count > 0)
            {
                ...
                var respuesta = MessageBox.Show($"¿Seguro que desea eliminar el Pais {paisSelected.Id}?", "Confirmar Eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            {
                MessageBox.Show("Debe seleccionar un Pais para eliminarlo", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void BtnModificar_Click(object sender, EventArgs e)
        {
            ...
            if (GridPaises.RowCount > 0 && GridPaises.SelectedRows.Count > 0)
            {
                ...
                TxtTitulo.Text = paisCurrent.Nombre;
                TabControl.SelectTab("TabPageAgregarEditar");
            }
        }
